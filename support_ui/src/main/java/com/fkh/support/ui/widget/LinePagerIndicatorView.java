...
public class LinePagerIndicatorView extends HorizontalScrollView {
...
//    = R.drawable.background_tab;//字体颜色的选择器
    ...
    public LinePagerIndicatorView(Context context) {
        this(context, null);
        this.mContext = context;
    }

    public LinePagerIndicatorView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        this.mContext = context;
    }

    public LinePagerIndicatorView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.LinePagerIndicatorView);

        indicatorColor = a.getColor(R.styleable.LinePagerIndicatorView_lpiindicatorColor, indicatorColor);
        underlineColor = a.getColor(R.styleable.LinePagerIndicatorView_lpiunderlineColor, underlineColor);
        dividerColor = a.getColor(R.styleable.LinePagerIndicatorView_lpidividerColor, dividerColor);
        indicatorHeight = a.getDimensionPixelSize(R.styleable.LinePagerIndicatorView_lpiindicatorHeight, indicatorHeight);
        underlineHeight = a.getDimensionPixelSize(R.styleable.LinePagerIndicatorView_lpiunderlineHeight, underlineHeight);
        dividerPadding = a.getDimensionPixelSize(R.styleable.LinePagerIndicatorView_lpidividerPadding, dividerPadding);
        tabPadding = a.getDimensionPixelSize(R.styleable.LinePagerIndicatorView_lpitabPaddingLeftRight, tabPadding);
        tabBackgroundResId = a.getResourceId(R.styleable.LinePagerIndicatorView_lpitabBackgrounds, tabBackgroundResId);
//        isSameLine = a.getBoolean(R.styleable.LinePagerIndicator_sameLine, isSameLine);
        scrollOffset = a.getDimensionPixelSize(R.styleable.LinePagerIndicatorView_lpiscrollOffset, scrollOffset);
        textAllCaps = a.getBoolean(R.styleable.LinePagerIndicatorView_lpitextAllCaps, textAllCaps);
        tabTextSize = a.getDimensionPixelSize(R.styleable.LinePagerIndicatorView_lpitabTextSize, tabTextSize);
        tabTextColor = a.getColor(R.styleable.LinePagerIndicatorView_lpitabTextColor, tabTextColor);
        tabTextColorSelected = a.getColor(R.styleable.LinePagerIndicatorView_lpitabTextColorSelected, tabTextColorSelected);
