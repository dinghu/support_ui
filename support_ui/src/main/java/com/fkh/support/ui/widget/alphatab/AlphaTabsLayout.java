package com.fkh.support.ui.widget.alphatab;
...
public class AlphaTabsLayout extends LinearLayout {
    ...
    public AlphaTabsLayout(Context context) {
        this(context, null);
    }

    public AlphaTabsLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AlphaTabsLayout(Context context, AttributeSet attrs, int defStyleAttr) {
